...
class EnemyShip extends Ship {
    ...
    public EnemyShip(float xCentre, float yCentre,
                     ...
                     int score, String name, int power,
                     TextureRegion shipTextureRegion,
                     TextureRegion shieldTextureRegion,
                     TextureRegion laserTextureRegion) {
        super(xCentre, yCentre, width, height, movementSpeed, shield, laserWidth,
                laserHeight, laserMovementSpeed, timeBetweenShots, shipTextureRegion,
    ...
    private void randomizeDirectionVector() {
        double bearing = MySpaceFarceGame.random.nextDouble()*6.283185; //0 to 2*PI
